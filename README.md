...
<html>
  ...
  <body>
    ...
    <footer>
        <center>Designed and Developed by <b>NARRA AKHIL (23003406)</b></center>
    </footer>
  </body>
</html>
```
...
<div class="banner">
    ...
    <div class="container">
        <div class="box-container">
            <div class="box">
                <img src="logo1.png" alt="Trumpet">
                <h3>TRUMPET</h3>
            </div>
            <div class="box">
                <img src="logo2.png" alt="Acoustic">
                <h3>ACOUSTIC GUITAR</h3>
            </div>
            <div class="box">
                <img src="logo3.png" alt="Piano">
                <h3>PIANO</h3>
            </div>
            <div class="box">
                <img src="logo5.jpeg" alt="Violin">
                <h3>VIOLIN</h3>
            </div>
        </div>
    </div>
